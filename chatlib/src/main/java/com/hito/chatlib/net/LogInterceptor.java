...
import com.hito.chatlib.log.MLog;
...
public class LogInterceptor implements Interceptor {
    ...
    private void logRequest(Request request) {
        try {
            ...
            MLog.d(TAG, "url : " + url);
            MLog.d(TAG, "method : " + request.method());
            ...
            if (requestBody != null) {
                ...
                if (mediaType != null) {
                    if (isText(mediaType)) {
                        MLog.d(TAG, "params : " + bodyToString(request));
                    } else {
                        MLog.d(TAG, "params : " + " maybe [file part] , too large too print , ignored!");
                    }
                }
            }
        } catch (Exception e) {
            ...
            if (body != null) {
                ...
                if (mediaType != null) {
                    if (isText(mediaType)) {
                        ...
                        MLog.json(Log.DEBUG, TAG, resp);

                        body = ResponseBody.create(mediaType, resp);
                        return response.newBuilder().body(body).build();
                    } else {
                        MLog.d(TAG, "data : " + " maybe [file part] , too large too print , ignored!");
                    }
                }
            }
